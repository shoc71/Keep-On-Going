...
class MenuScene(LevelScene):
    ...
    def __init__(self, xspawn, yspawn, level_memory):
        ...
        self.options = [LevelSelect(level_memory), OptionsPage(level_memory),
                        ...
                        LevelZero(level_memory), Filler(level_memory),
        ...
        self.title_text_s5 = dsnclass.Text("Level Zero", (216, 535), 30,
                                           "impact",
                                           YELLOW, None)
...
class StatsPage(LevelScene):
    ...
    def update_stats(self):
        ...
        total_time = dsnclass.convert_time(self.memory.total_time)
...
class PlayLevel(LevelSelect):
    ...
    def __init__(self, x_spawn, y_spawn,
        ...
        if self.memory.enable_replay:
            ...
            self.replayer = dsnclass.SquareMe(self.replayer_xspawn,
...
class LevelZero(LevelScene):
    ...
    def pass_word_morse_code(self, a_string, display):
        adict = {
        ...
        if a_string in adict:
            display = adict[b_string]
        else:
    ...
    def render(self, screen):
        ...
        self.clear_code_morse_block = [pygame.draw.rect(screen, BLUE, [745, 433, 100, 71])] # bottom 480
        self.convert_code_morse_block = [pygame.draw.rect(screen, DARK_GREEN, [495, 433, 100, 71])]
        self.check_correct_morse_block = [pygame.draw.rect(screen, LIME_GREEN, [212, 433, 100, 71])]
        self.clear_all_text = [pygame.draw.rect(screen, LIGHT_RED, [100, 433, 50, 71])]
        ...
        # self.test_text_3 = dsnclass.Text(self.str_morse_code, (545, 413),
        #                                 35, "impact", DARK_GREY, None)
        # screen.blit(self.test_text_3.text_img,
        #                 self.test_text_3.text_rect)  # draw text
