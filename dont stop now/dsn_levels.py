...
class LevelZero(LevelScene):
    ...
    def update(self):
        ...
        if self.morse_code_count < 5:
            if self.player.alive and \
                ...
                self.str_morse_code = ""
                self.morse_code_count = 0
                print("morse code text has been cleared! More needs to be here!")
                print(f"{self.str_morse_code} and {self.morse_code_count}")
    ...
    def render(self, screen):
        ...
        self.clear_code_morse_block = [pygame.draw.rect(screen, BLUE, [642, 455, 72, 71])]
        self.convert_code_morse_block = [pygame.draw.rect(screen, DARK_GREEN, [415, 455, 72, 71])]
        self.check_correct_morse_block = [pygame.draw.rect(screen, LIME_GREEN, [192, 455, 72, 71])]
