...
class LevelScene(Scene):
    ...
    def update(self):
        print(start_music.current_track_index)
...
class TutorialLevel1(LevelScene):
    def __init__(self, x_spawn, y_spawn):
        ...
        self.Tut6_text = Text("Ta dudorial", (600, 400), 45, "impact", GREY,
                              None)
...
class TutorialLevel2(LevelScene):
    def __init__(self, x_spawn, y_spawn):
        LevelScene.__init__(self, x_spawn, y_spawn)
        self.Tut5_text = Text("The mAze...", (210, 400), 75, "impact", GREY,
                              None)
...
class TutorialLevel4(LevelScene):
    def __init__(self, x_spawn, y_spawn):
        LevelScene.__init__(self, x_spawn, y_spawn)
        self.Tut7_text = Text("sandwich", (110, 400), 75, "impact", GREY, None)
...
class TutorialLevel5(LevelScene):
    def __init__(self, x_spawn, y_spawn):
        LevelScene.__init__(self, x_spawn, y_spawn)
        self.Tut4_text = Text("This is not the same spot", (800, 100), 15,
                              "impact", YELLOW, None)
...
class TutorialLevel6(LevelScene):
    def __init__(self, x_spawn, y_spawn):
        LevelScene.__init__(self, x_spawn, y_spawn)
        self.Tut4_text = Text("Jump under platform", (800, 100), 15,
                              "impact", YELLOW, None)
